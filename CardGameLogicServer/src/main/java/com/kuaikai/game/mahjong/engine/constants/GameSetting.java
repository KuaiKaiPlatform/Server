...
public class GameSetting {
	...
	/** 麻将局数：8、16  */
	public final static String TOTAL_SET = "total_set";

	/** 麻将圈数：1、2、3  */
	public final static String TOTAL_QUAN = "total_quan";
	
	/** 麻将底数（完成所有底时结束游戏）：1、2、3  */
	public final static String TOTAL_DI = "total_di";
	
	/** 麻将人数：4、3、2  */
	public final static String TOTAL_PLAYER = "total_player";

	/** 首局手动准备（玩家选座时为手动准备）  */
	public final static String MANUAL_READY_TO_BEGIN = "manual_ready_to_begin";

	/** 首局选座模式：SEQUENCE 按顺序入座、PLAYER 玩家选座、RANDOM 随机选座  */
	public final static String CHAIR_MODE = "chair_mode";
	
	/** 麻将初始手牌数：13  */
	public final static String INIT_HAND_CARD_NUM = "init_hand_card_num";

	/** 牌池剩余牌数时荒庄：0 */
	public final static String REMAIN_CARD_NUM = "remain_card_num";

	/** 基础分 */
	public final static String BASE_RATE = "base_rate";
	
	/** 胡牌基础分 */
	public final static String BASE_RATE_HU = "base_rate_hu";

	/** 去筒：1 */
	public final static String QU_TONG = "qu_tong";
	
	/** 去条：1 */
	public final static String QU_TIAO = "qu_tiao";

	/** 去字  */
	public final static String QU_ZI = "qu_zi";

	/** 带红中 */
	public final static String HONG_ZHONG = "hong_zhong";
	
	/** 红中赖子 */
	public final static String HONG_ZHONG_ALMIGHTY = "hong_zhong_almighty";

	/** 是否跟庄 */
	public final static String GEN_ZHUANG = "gen_zhuang";
	
	/** 是否一炮多响 */
	public final static String MULTIPLE_HU = "multiple_hu";
	
	/** 是否庄家翻倍 */
	public final static String BANKER_DOUBLE = "banker_double";

	/** 是否荒庄翻倍 */
	public final static String HUANG_ZHUANG_DOUBLE = "huang_zhuang_double";
	
	/** 点炮三家付 */
	public final static String DIAN_PAO_PAYER_ALL = "dian_pao_payer_all";

	/** 点杠三家付 */
	public final static String DIAN_GANG_PAYER_ALL = "dian_gang_payer_all";

	/** 点炮者支付点杠分 */
	public final static String DIAN_PAO_PAY_DIAN_GANG = "dian_pao_pay_dian_gang";

	/** 点炮者支付补杠和暗杠分 */
	public final static String DIAN_PAO_PAY_OTHER_GANG = "dian_pao_pay_other_gang";
	
	/** 点杠包三家：点杠一家付时生效 */
	public final static String DIAN_GANG_PAY_ALL = "dian_gang_pay_all";

	/** 点炮包三家：点炮一家付时生效 */
	public final static String DIAN_PAO_PAY_ALL = "dian_pao_pay_all";
